			...
			<li class="span4">
				<div class="thumbnail">
					...
					<?php echo CMImage::image( Yii::app()->baseUrl.'/images/instructors/' . $instructor->attributes['photo'], '', 
							array(
								'timthumb' => array('w' => 350, 'h' => 320), 
								'rel' => 'prettyPhoto')); ?>
					</a>
					<div class="caption">
						<h4><?php echo $instructor->attributes['fname'] . ' ' . $instructor->attributes['lname']; ?></h4>
						...
						<?php endif; ?>
							<div class="address_txt">Николаев, ул. Садовая 33, Строительный колледж</div>
