...
class PhotoController extends Controller
{
	...
	{		
		...
		if(isset($_POST['Photo']))
		{
			...
			$model->visible = $_POST['Photo']['visible'];
			$model->sort_order = $_POST['Photo']['sort_order'];
			...
			{			
				$uploadedFile->saveAs(getcwd().'/images/photos/'.$model->src);
	...
	public function actionUpdate($id)
	{
		...
		{		
			...
			if($model->save()) 
			{
                ...
                {					
                    $result = $uploadedFile->saveAs(getcwd().'/images/photos/'.$model->src);					
                }
				$this->redirect(array('view','id'=>$model->id));
			}			
		}
	...
	public function actionDelete($id)
	{
		...
		$filename = getcwd().'/images/photos/'.$model->src;
