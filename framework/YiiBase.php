			...
			if($isClass)
			{
				if($forceInclude)
				{
					if(is_file($path.'.php'))
						...
						throw new CException(Yii::t('yii','Alias "{alias}" is invalid. Make sure it points to an existing PHP file and the file is readable. Path '.$path.'.php',array('{alias}'=>$alias)));
